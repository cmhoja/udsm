<?php
$this->title = Yii::$app->params['static_items']['announcement'][Yii::$app->language];
?>
        ...
        <div class="row">
            ...
            <div class="pull-left col-sm-12 col-md-9">
                <div class="section-title" style="margin-bottom: 3%;">
                    <h3 ><?php echo Yii::$app->params['static_items']['announcement'][Yii::$app->language]; ?></h3>
                </div>
                <div class="col-md-12 col-md-12">
                    <?php
                    if (isset($page_content) && $page_content) {

                        foreach ($page_content as $announcement) {
                            $announcementTitle = (Yii::$app->language == 'sw') ? $announcement->TitleSw : $announcement->TitleEn;
                            ?>
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-md-10">
                                    ...
                                    <div class="post-meta">
                                        ...
                                        <span class="time">
                                            <i class="fa fa-calendar"></i> <?php echo Date('D.M.Y @ H:i:s', strtotime($announcement->DatePosted)); ?></span>
                                    </div>
