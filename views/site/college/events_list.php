<?php
$this->title = Yii::$app->params['static_items']['events'][Yii::$app->language];
?>
            ...
            <div class="pull-left col-sm-12 col-md-9">
                ...
                <div>
                    ...
                    if (isset($page_content) && $page_content) {
                        ...
                        foreach ($page_content as $events) {
                            $eventsTitle = (Yii::$app->language == 'sw') ? $events->EventTitleSw : $events->EventTitleEn;
                            ?>
                            <div class="row">
                                <div class="">
                                    <h2 class="post-title">
                                    ...
                                    <div class="post-meta">
                                        ...
                                        <span class="time">
                                            <i class="fa fa-calendar"></i> <?php echo Date('D.M.Y @ H:i:s', strtotime($events->DatePosted)); ?></span>
                                    </div>
