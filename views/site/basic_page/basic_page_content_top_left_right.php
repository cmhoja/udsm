...
<div class="row">
    <div class="col-md-8">
        <?php
        if (isset($page_content_top_left_blocks)) {
            foreach ($page_content_top_left_blocks as $block) {
                ?>
                <div class="section-title text-left">
                    <h2 class="title">
                        ...
                        <?php endif; ?>
                        <?php echo (Yii::$app->language == 'sw') ? $block->BlockTitleSw : $block->BlockTitleEn; ?></h2>
                </div>
        ...
        <!--MENU ITEMS-->
        <?php
        if (isset($page_content_top_left_menus) && $page_content_top_left_menus) {
            foreach ($page_content_top_left_menus as $key => $menu_group) {
                ?>
                <?php
    ...
    <div class="col-md-4">
        <?php
        if (isset($page_content_top_right_blocks)) {
            foreach ($page_content_top_right_blocks as $block) {
                ?>
                <div class="section-title text-left">
                    <!-- Heading -->
                    <h2 class="title">
        ...
        <!--MENU ITEMS-->
        <?php
        if (isset($page_content_top_right_menus) && $page_content_top_right_menus) {
            foreach ($page_content_top_right_menus as $key => $menu_group) {
                ?>
                <?php
                if ($menu_group['DisplayNameEn'] OR $menu_group['DisplayNameSw']):
                    $menu_group_title = (Yii::$app->language == 'sw') ? $menu_group['DisplayNameSw'] : $menu_group['DisplayNameEn'];
