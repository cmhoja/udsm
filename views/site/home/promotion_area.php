            ...
            <div class="row text-center">
                ...
                foreach ($content_footer_top_area as $promotion_block) {
                    ...
                    <div class="col-sm-2 col-md-2">
                        <a  target="<?php echo $promotion_block->LinkToPage?'_blank':'' ?>"href="<?php echo $promotion_block->LinkToPage?\app\components\Utilities::generateUrl($promotion_block->LinkToPage):''; ?>"><i class="fa  <?php echo $promotion_block->BlockIconCSSClass; ?> text-color fa-2x icons-circle"></i>
