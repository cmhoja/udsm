            ...
            <div class="row text-center">
                ...
                foreach ($content_footer_top_area as $promotion_block) {
                    ...
                    <div class="col-sm-2 col-md-2">
                        <a href="<?php echo \app\components\Utilities::generateUrl($promotion_block->LinkToPage); ?>"><i class="fa  <?php echo $promotion_block->BlockIconCSSClass; ?> fa-certificate text-color fa-2x icons-circle"></i>
