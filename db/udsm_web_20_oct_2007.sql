...
--
-- Host: localhost
-- Generation Time: Oct 20, 2017 at 03:00 AM
...
(21, 5, 1, 'COET', 'COET NEWS', 'COET NEWS TO BE DISPLAYED', 'SDSGSDHHKJ4W6EYRR55TUJYVWEWRDTFGYHJWERTYUIASDFGHJ', 'SAAAAAAAAADF', 'UNIT_BLOCK_COET NEWS.jpg', 'fa-handshake-o', '', '', 'CT_HSR', '0', 1),
(22, 5, 1, 'About us home page', 'Connect', 'Connect here', 'sdcs', 'rerd', 'UNIT_BLOCK_Connect.jpg', '', '<div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://www.youtube.com/embed/TMY0iTcspNA?ecver=2" width="640" height="360" frameborder="0" style="position:absolute;width:100%;height:100%;left:0" allowfullscreen></iframe></div>', '', 'CT_HCTR', '0', 1),
...
(28, 5, 1, 'Latest news', 'Latest news', 'Habari mpya', 'aroooooooooooooooooooooooooooooooooooooo', 'arooooooooooooooooooooooooooooooooooooooooooooo', NULL, '', '', '', 'CT_HCTL', '0', 1),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Keeps a list of all the menus names in the website' AUTO_INCREMENT=35 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Keeps a list of all links for a particular menu item' AUTO_INCREMENT=186 ;
...
(3, NULL, 1, 'About UDSM', 'Kuhusu UDSM', 'about-us/background', 0, 0, 2, NULL, 1),
...
(6, NULL, 1, 'Academic Units', 'Vitengo vya Elimu', '/academic-units', 0, 0, 3, NULL, 1),
...
(37, NULL, 1, 'Consituent College', 'Vyuo Shirikishi', '#', 0, 6, 1, NULL, 1),
...
(42, NULL, 1, 'DUCE', 'DUCE', 'college/duce', 0, 37, 1, NULL, 1),
...
(108, '', 8, 'About College', 'Kuhusu CONAS', 'college/coict/aboutus', 0, 0, 18, NULL, 1),
(109, '', 8, 'Programmes', 'Kozi Mbali mbali', 'college/coict/programmes', 0, 0, 2, NULL, 1),
(110, '', 8, 'Department & Units', 'Idara &  Vitengo', 'college/connas/department-and-units', 0, 0, 3, NULL, 1),
...
(176, '', 8, 'Home', 'Home', '/', 0, 0, 1, NULL, 1),
(178, '', 23, 'About Us', 'About Us', 'colleges/coet/about-us', 0, 0, 1, NULL, 1),
