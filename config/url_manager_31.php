...
return [
    ...
    'rules' => [
        ...
        'colleges/<code>/announcement/<item>' => 'college/announcements',
        'colleges/<code>/announcement/<item>' => 'college/announcements',
        'colleges/<code>/announcements' => 'college/announcements',
        'colleges/<code>/announcement' => 'college/announcements',
        'colleges/<code>/<page>/<action>' => 'college/<action>',
        'colleges/<code>/<page>' => 'college/page',
        'colleges/<code>/<page>/<item>' => 'college/index',
        'colleges/<code>/<page>/<item>/<subitem>' => 'college/index',
        'colleges/<code>/<page>/<item>/<subitem>/<subitem2>' => 'college/index',
        //SCHOOLS PAGES
