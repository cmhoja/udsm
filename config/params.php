...
return [
    ...
    'authType' => 'ldap', //ldap///this parameter defines the authentication system to be used to authenticte user of the system. only one of the two( ldap or system) authentication is require
